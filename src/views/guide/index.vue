  ...
  <div class="page">
    ...
    <MyCard class="box-card">
      ...
      <div class="text-box">
        ...
        <p>
          5、本框架demo案例分为三部分：模板页面、公共元素和页面模块，其中公共元素和页面模快提供查看源码功能，可以直接将对应demo进行复制使用，
          模板页面部门不支持查看源码，如有需要请到src\views\modules查看相应源码文件。
        </p>
      </div>
    </MyCard>
    <MyCard class="box-card margint10">
      <div slot="header" class="clearfix">
